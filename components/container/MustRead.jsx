      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-1 py-24">
        ...
        <div className="h-full">
          <div className="relative w-full h-full group overflow-hidden">
            <Link href={`/${sanitizeUrl(selectedData[0]?.title)}`}>
            <Image
              src={`${imagePath}/${selectedData[0]?.image}`}
            ...
            <div className="absolute p-4 left-0 bottom-0 text-white flex flex-col gap-3">
              <Link
                href={`/category/${selectedData[0]?.article_category}`}
                ...
                {selectedData[0]?.article_category}
              </Link>
              <Link
              ...
              <div className="flex flex-row gap-2">
                <h2 className="text-xs font-montserrat font-semibold">
                  {selectedData[0]?.author}&nbsp;&nbsp;-
                </h2>
                <h2 className="text-xs font-montserrat">
                  {selectedData[0]?.published_at}
                </h2>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-1 h-full">
          ...
          <Link href={`/${sanitizeUrl(selectedData[1]?.title)}`}>
            <Image
          ...
          <div className="flex flex-row gap-1 h-1/2">
            ...
            <Link href={`/${sanitizeUrl(selectedData[2]?.title)}`}>
              <Image
            ...
            {/* Bottom Right */}
            <div className="relative w-1/2 group overflow-hidden">
            <Link href={`/${sanitizeUrl(selectedData[3]?.title)}`}>
              <Image
