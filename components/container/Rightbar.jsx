  ...
  return (
    <div className="sticky top-5 pt-14 ">
      <div className="flex items-start border-b-2 mb-7 border-quinary">
        <h4 className="text-sm text-white py-1 bg-quinary px-2 uppercase font-montserrat ">
          Featured Article
        </h4>
      </div>
...
function Aboutme({ data, imagePath, content }) {
  return (
    ...
    >
      ...
      <p className="text-sm leading-4 line-clamp-4 text-center group-hover:text-primary transition-all duration-300 font-montserrat">
